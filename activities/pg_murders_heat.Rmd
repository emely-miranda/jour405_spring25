...
The data shows that there is a positive correlation between temperature and murders. The calculation shows a .58 correlation, which is pretty positive, but it is not a perfect correlation. 
