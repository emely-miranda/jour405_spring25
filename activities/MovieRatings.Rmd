...
From looking at the data, the expected frequency is different from the observed frequency. However, I would not say there is a huge difference in any of the categories.
...
Yes I would reject the null hypothesis. The chi-square statistic (9.9521) is greater than the critical value (9.487729), meaning that observed frequency is significantly different from the expected frequencies.
