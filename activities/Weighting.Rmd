...
1. Which voter category shows the biggest difference between weighted and unweighted results?
    The voters who rarely/never vote.

2. How might these differences affect reporting on likely voter turnout?
  In a close election, even small shifts matter, so accurate weighting helps reporters avoid misleading projections.
...
3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample?
  These differences  exist because the likelihood of voting can be over-represented, especially among less frequent or even sporadic voters where the percentage differences are larger. 
