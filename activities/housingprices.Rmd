...
After discussing the results, each person writes a couple of sentences for the top of a story about local officials' claims on the impact of the transit line and what the data says. Remember that there are lots of possible reasons that could influence the price of a home. Make your sentences newsy.

Local officials claimed that the construction of a new rail line increased the property value of a local neighborhood. Statistical evidence supports the claims after the data showed that recent home sales are greater than the previous average home sale price. The evidence showed a 95% relationship between the new rail line and the increase in property value.
