...
I would say a good portion of the data lies between 5 and 15, with some points going over 15. I would draw a horizontal line between 15 and 20 as unusually high, and at 5 for unusually low.
...
This differs from my answer because I was looking at the outliers and how there are fewer points above 15. This answer focuses on where there are high amount of calls around 11 and and a low amount around 7.
...
Tuesday has the highest number of 911 calls for drug overdoses compared to other days of the week.
...
The data shows that on Tuesday there are high rates of 911 calls for drug overdoses compared to other days of the week. There was an unusual high amount of calls on Oct. 4, 2022. The next steps would be to figure out if there was something about that specific day that led to the number of calls.
