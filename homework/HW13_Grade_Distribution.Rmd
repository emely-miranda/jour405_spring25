...
At first glance, I don't the differences are meaningful because they don't seem too far off from the expected results. The largest differences are A and C that are -20 and +20 students, respectively.
...
Yes we reject the null hypothesis because the chi-square statistic is greater than the critical value. 11.667 > 9.487729. 
...
The noticeable discrepancies are grades A and C with a frequency of +20 and -20 of the expected frequency, respectively. The other grades are smaller differences: B +5, D +5, F -10.

Questions one could ask:
- Did the instructor/college offer additional tutoring or academic support that may have helped students before better?
- How do the current grades compare to last semester or year?
- If we looked at the grades of another group of 400 students would the results be similar?
- Were any grades curved?
