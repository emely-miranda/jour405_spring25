...
The data shows a list of all the cities Maryland with at least 10,000 people. The data has columns with different races and ethnicities and the number of people in each city that identify with said race/ethnicity. When I toggle through the populations of each race/ethnicity, Baltimore City seems to be the most diverse city. Georgetown also stands out in some categories. 
...
The city with the highest probability--87%--is Summerfield. I think because this city has a large Black population and it is significantly greater than the other races/ethnicities in this city, so the probability of two Black people meeting in this city is very likely.
...
One thing I noticed is that the lowest Hispanic probability scores are 50% and above. Another thing I noticed is that the other race probability scores are also low.
...
Langley Park (97%), Wheaton (91%) and Adelphi (90%) are the most diverse. Langley Park and Adelphi are in Prince George's County, though I think parts of Langley Park might be in Montgomery County. Wheaton is in Montgomery County. Lake Shore (15%) is the least diverse. It is located in Anne Arundel County near the Chesapeake Bay. 
...
In a majority-Black community, racial diversity is still low

Despite a large minority population, Summerfield, Md. has surprisingly low racial diversity. An analysis of U.S. Census data shows that Summerfield has a race probability of 87% --- meaning there's an 87% chance that any two randomly selected residents will be the same race. The city's diversity index is just 22%, indicating there's less than a one-in-four chance that two residents will be of different races.
