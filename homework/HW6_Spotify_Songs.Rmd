...
The histogram shows a pretty normal distribution that is slightly skewed to the right. The mean is 0.673 with a standard deviation of .16. A majority of the data lies between the two standard deviation lines in the histogram. I think this data tells us that of the songs in the data, they are of medium danceability. 

I think a story idea would be to find common aspects of songs with the most danceability, and see what the songs with average danceability "lack." I also think talking about what danceability means and how that changes in different genres of music.
